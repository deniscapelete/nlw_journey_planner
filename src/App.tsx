...
export function App() {
  ...
  const [isConfirmTripModalOpen, setIsConfrimTripModalOpen] = useState(false)
          ...
          <div className='w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
            ...
            <form onSubmit={addNewEmailToInvite} className='p-2.5 bg-zinc-950 border border-zinc-800 rounded-lg flex items-center gap-2'>
              <div className='px-2 flex items-center flex-1 gap-2'>
                ...
                <input name='email' type="text" placeholder="Digite o e-mail do convidado?" className="bg-transparent text-lg placeholder-zinc-400 outline-none flex-1" />
              </div>
